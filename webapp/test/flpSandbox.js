		...
		services: {
					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "App Lists",
									"targetURL": "#mrocajapplists-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"mrocajapplists-display": {
								"semanticObject": "mrocajapplists",
								"action": "display",
								...
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=mrocaj.applists",
									"url": sap.ui.require.toUrl("mrocaj/applists")
								}
							}
						}
					}
